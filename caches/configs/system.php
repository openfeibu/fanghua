...
'cookie_pre' => 'qfHyR_', //Cookie 前缀，同一域名下安装多套系统时，请修改Cookie前缀
...
'js_path' => '/fanghua/statics/js/', //CDN JS
'css_path' => '/fanghua/statics/css/', //CDN CSS
'img_path' => '/fanghua/statics/images/', //CDN img
'app_path' => 'http://localhost/fanghua/',//动态域名配置地址
...
'gzip' => 1, //是否Gzip压缩后输出
'auth_key' => '6Hosci1iNtMF90GHu8D7', //密钥
'lang' => 'zh-cn',  //网站语言包
...
'phpsso' => '0',	//是否使用phpsso
'phpsso_appid' => '1',	//应用id
'phpsso_api_url' => 'http://localhost/fanghua/phpsso_server',	//接口地址
'phpsso_auth_key' => 'AnUgXHtCgnOPOiMbUz5f9Lwo00iXAtyS', //加密密钥
