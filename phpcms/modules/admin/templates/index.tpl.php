...
<style type="text/css">
/*样式隐藏*/
/*设置 phpsso 用户 界面 扩展 视频*/
#_M1,#_M2,#_M8,#_M5,#_M6,#_M7,#_M9{ display:none}
/*内容*/
#_MP857{ background:red}
#_MP868,#_MP945,#_MP957,#_MP1509,#_MP1601,#_MP1501,#_MP872,	#_MP874,#_MP32,#_MP59{ display:none}
/*默认站点*/
    ...
    <?php echo L('current_position')?><span id="current_pos"></span></div>
    	<div class="col-1">
        	<div class="content" style="position:relative; overflow:hidden">
                <iframe name="right" id="rightMain" src="tycms.html" frameborder="false" scrolling="auto" style="border:none; margin-bottom:30px" width="100%" height="auto" allowtransparency="true"></iframe>
                <!--<div class="fav-nav">
					<div id="panellist">
